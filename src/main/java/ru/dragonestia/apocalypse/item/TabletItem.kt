...
class TabletItem @JvmOverloads constructor(meta: Int? = 0, count: Int = 1) : Item(ApocalypseID.TABLET, 0, count, "Tablets"), AdvItem {
    ...
    override fun getRuName(): String = "Самодельный радиопротектор"

    override fun getIcon(): String = "textures/items/rad/tablet"
